...
INSERT INTO `academia` VALUES (1,'Academia Two Paypal');
...
CREATE TABLE `adm` (
  ...
  CONSTRAINT `fk_adm_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
INSERT INTO `aluno` VALUES (1,'Migrado do sistema antigo',0,NULL,1,999),(2,'Migrado do sistema antigo',0,NULL,1,999),(3,'Migrado do sistema antigo',0,NULL,1,999),(4,'Migrado do sistema antigo',0,NULL,1,999),(5,'Migrado do sistema antigo',0,NULL,1,999),(6,'Migrado do sistema antigo',0,NULL,1,999);
...
INSERT INTO `instrutor` VALUES (999,1);
...
INSERT INTO `usuarios` VALUES (1,'Usuário Insomnia','insomnia@email.com','$2b$12$2IUSQcT4VrJGOkY8aALuq.iyvlwI8oNHUJQvz.jz5h4e2m02EPeca','','aluno',NULL),(2,'jose','jose.jose@gmail.com','$2b$12$Emh/0.vcS4BCXovR/B.clOHqTykLdUxi1zBiNWfl8D5mCTJuZ3HWa','','aluno',NULL),(3,'bolsonaro','bolsonaro.jair@gmail.com','$2b$12$7j8KZCx.WSDWcejwukgKZO.IwdmD0Sc5fnFz2fh8V4G0Or8vfbkTC','','aluno',NULL),(4,'testeEnzo','testeenzo@gmail.com','$2b$12$Cq9Q0svLZ3hJtD2wHNQ43.WfImeZ38NqxRO0yxTaiiieBt3G./mJy','','aluno',NULL),(5,'Pedro','pedro@gmail.com','$2b$12$vkFYVyF8hqx/gwH.5rXFgeRyBfantVQywAhXeMjaaT5yvSYS96gqy','','aluno',NULL),(6,'gabriel','testegabriel@gmail.com','$2b$12$aDNk1j3e4Ncy6LMbGJ7cLuxURM7EQbxkmsfRBrplJSq4owy2Hy1AG','','aluno',NULL),(999,'Instrutor Chefe','instrutor@sistema.com','hash_falso','00000000','instrutor',NULL);
...
-- Dump completed on 2025-11-27 23:58:11
