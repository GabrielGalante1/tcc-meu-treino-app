...
Pode ser utilizado tanto por professores para criar o treino e gerenciar o treino de seus alunos, quanto por pessoas simples que apenas querem treinar em sua rotina.

## 🚀 Sobre o Projeto

Levando em consideração a complexidade da grande maioria dos aplicativos que seguem o mesmo genero, estamos focando em simplicidade e facilidade, sem a necessidade de pagar por funcionalidades básicas que necessitam de pagamento em outros aplicativos.
...
* ✅ **Login:** Implementamos a funcionalidade de login, que permite acessar a sua conta de forma segura por meio de uma senha criptografada.
* ✅ **Perfil:** Implementamos a funcionalidade de perfil, uma página que serve para que os usuários vejam e editem seus dados cadastrados.
* ✅ **Visualização das fichas de treino:** Essa funcionalidade garante que os usuários vejam e modifiquem os detalhes de seus treinos conforme desejado.
...
```bash
git clone https://github.com/EnzoQuinalha/tcc-meu-treino-app.git
